...
async function hashPassword() {
  ...
  try {
    // Generate a salt with 10 rounds (const factor)
...
async function comparePassword() {
  ...
  const hashedPassword = "$2b$10$53INf2dVGP0NvBijbVF07.LALFqF2f2j4bPvjzyCkWtrZF5ywSNsa"; // Replace with the hashed password stored in your application
